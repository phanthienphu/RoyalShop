...
(function (app) {
    ...
    ProductImportController.$inject = ["$scope", "apiService","$http","authenticationService", "notificationService", "$state", "commonService"];

    function ProductImportController($scope, apiService, $http, authenticationService, notificationService, $state, commonService) {
